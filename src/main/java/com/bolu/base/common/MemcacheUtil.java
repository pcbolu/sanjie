...
//        pool.initialize();
    ...
    {  
        ...
        {  
            // 记录Memcached日志  
            writeLog("Memcached set方法报错，key值：" + key + "\r\n" + exceptionWrite(e));  
        }  
        return flag;  
    }  
    ...
    {  
        ...
        {  
            // 记录Memcached日志  
            writeLog("Memcached add方法报错，key值：" + key + "\r\n" + exceptionWrite(e));  
        }  
        return flag;  
    }  
    ...
    {  
        ...
        {  
            writeLog("Memcached replace方法报错，key值：" + key + "\r\n" + exceptionWrite(e));  
        }  
        return flag;  
    }  
    ...
    {  
        ...
        {  
        	obj = null;
        	writeLog("Memcached get方法报错，key值：" + key + "\r\n" + exceptionWrite(e));  
        }  
        return obj;  
    }  
    ...
    {  
        ...
        {  
            writeLog("Memcached delete方法报错，key值：" + key + "\r\n" + exceptionWrite(e));  
        }  
        return flag;  
    }  
    ...
    {  
        ...
        {  
            writeLog("Memcached flashAll方法报错\r\n" + exceptionWrite(e));  
        }  
        return flag;  
    }  
